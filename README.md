...
* In order to simplify calculations transformation from global to local coordinates is applied (**lines 402 - 409**).
...
* To avoid jerk issues speed of the car is updated gradually depending on the traffic (**lines 208, 325, 333**).
